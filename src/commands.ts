...
import { updateTOC, insertTOCConfig, getHeadlines } from './toc';
...
export function registerCommands(context: vscode.ExtensionContext): void {
  ...
  const moveCmdDisposable = vscode.commands.registerCommand('markdownToc.moveToHeading', async () => {
  ...
  context.subscriptions.push(moveCmdDisposable);
